...
const Contact = () => {
    return (
        <div>
            <div className="lg:max-w-screen-xl max-w-sm mx-auto my-10 lg:my-36">
            <div className="bg-[url('./public/cta.jpg')] bg-cover pl-5 lg:pl-14 py-12 lg:pt-40 lg:pb-36">
                <p className="text-4xl lg:text-7xl font-extrabold text-white pb-6">We are here to help</p>
                <p className="text-lg lg:text-2xl font-medium text-white pb-6">Put PSI’s secure testing solutions to work for you.</p>
